<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="{{URL::to('/')}}" class="brand-link">
    <img src="{{URL::to('/public')}}/assets/img/favicon.png" alt="DataMySite" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light"> DataMySite</span>
  </a>
