          ...
          <div class="container">
            ...
            <div class="row gy-4 first-row">
                ...
                <div class="col-lg-2 vertical-center">
                    <img src="{{URL::to('/public/section-images/image87.png')}}" width="100%" alt="Why choose us">
                </div> 
        ...
        <section id="service-cards" class="blog-section section striped-section why-us-section why-out-us-section">
          ...
          <div class="container">
            ...
            <div class="row gy-4 first-row">
                ...
                <div class="col-lg-1"></div>
                <div class="col-lg-3 vertical-center">
                    <img src="{{URL::to('/public/section-images/image89.png')}}" width="100%" alt="Why choose us">
                </div> 
            </div>
        ...
        <section id="service-cards" class="blog-section section why-us-section why-out-us-section">
          ...
          <div class="container">
            ...
            <div class="row gy-4 first-row split-block">
                ...
                <div class="col-lg-3 vertical-center">
                    <img src="{{URL::to('/public/section-images/image90.png')}}" width="100%" alt="Why choose us">
                </div> 
                <div class="col-lg-1"></div>
...
.
                ...
                <div class="col-lg-1"></div>
                <div class="col-lg-3 vertical-center">
                    <img src="{{URL::to('/public/section-images/image91.png')}}" width="100%" alt="Why choose us">
                </div> 
            </div>
