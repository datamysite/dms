          ...
          <div class="container">
            ...
            <div class="row gy-4 first-row">
                ...
                <div class="col-lg-4 vertical-center">
                    <img src="{{URL::to('/public/section-images/image18.png')}}" class="side-image" width="100%" alt="Impact of PR Coverage">
                </div>
        ...
        <section id="service-cards" class="blog-section section pr-icon-section">
          ...
          <div class="container">
            ...
            <div class="row gy-4 first-row">
                ...
                <div class="col-lg-4 vertical-center">
                    <img src="{{URL::to('/public/section-images/image19.png')}}" class="side-image" width="100%" alt="Impact of PR Coverage">
                </div>
            </div>
